...
description: "Use when working with Yii2 application structure, entry points, configuration merging, environment initialization, path aliases, application properties, or lifecycle events."
version: 1.0.0
---
