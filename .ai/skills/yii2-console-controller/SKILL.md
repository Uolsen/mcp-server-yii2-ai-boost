---
name: yii2-console-controller
description: "Use when creating or modifying console commands, CLI tools, cron jobs, background tasks, or any yii console controller actions."
version: 1.0.0
---
