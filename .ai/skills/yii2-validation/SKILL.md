---
name: yii2-validation
description: "Use when implementing form validation, model rules, custom validators, scenarios, conditional validation, or handling validation errors."
version: 1.0.0
---
