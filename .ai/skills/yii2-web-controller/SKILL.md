---
name: yii2-web-controller
description: "Use when creating or modifying web controllers, handling HTTP requests, rendering views, redirects, access control, REST APIs, or CRUD actions in frontend or backend."
version: 1.0.0
---
